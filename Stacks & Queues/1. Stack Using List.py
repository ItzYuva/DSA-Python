...
# By using __stack, I make the internal list private. This forces users to use the methods I defined — like push() and pop() to interact with the stack.
# It prevents direct modification of the data structure, ensuring the stack’s behavior stays consistent and encapsulated.
